...
Initializes the dac by giving it an address (the one used by \hyperlink{class_i2_c}{I2C} to access it) In our project it is already grounded, so the address is set as 0x50 
