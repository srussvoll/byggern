...
\item 
\hypertarget{class_stream_a64afe78be56687f804c3854758bc93fa}{void($\ast$ {\bfseries event\-\_\-input\-\_\-buffer\-\_\-not\-\_\-empty} )(\hyperlink{class_stream}{Stream} $\ast$stream) = nullptr}\label{class_stream_a64afe78be56687f804c3854758bc93fa}

\item 
\hypertarget{class_stream_a554ebe38cc3623e1caad8f9cb6a1906c}{void($\ast$ {\bfseries event\-\_\-output\-\_\-buffer\-\_\-not\-\_\-empty} )(\hyperlink{class_stream}{Stream} $\ast$stream) = nullptr}\label{class_stream_a554ebe38cc3623e1caad8f9cb6a1906c}
...
This class implements a duplex F\-I\-F\-O stream using two circular buffers. For instance both an R\-S232 driver and a \hyperlink{class_c_a_n}{C\-A\-N} driver would need to implement a stream. Inheriting from this interface makes the communication interface for R\-S232, \hyperlink{class_c_a_n}{C\-A\-N} and other stream based classes/drivers the same, meaning the end user does not need to know whether the data being sent is being sent over a \hyperlink{class_u_a_r_t}{U\-A\-R\-T} or a \hyperlink{class_c_a_n}{C\-A\-N} bus.

As an example you can set up a \hyperlink{class_c_a_n}{C\-A\-N} bus using a \hyperlink{class_c_a_n}{C\-A\-N} driver inheriting from this interface. Then it can be passed to a function expecting to send data to an R\-S232 class also inheriting from this interface, and it will just work. This interface is in other words written to make it easier to write consistent and driver independent code. 

\subsection{Constructor \& Destructor Documentation}
\hypertarget{class_stream_a2b738d6f4d3059de2ae3d444d68663bf}{\index{Stream@{Stream}!Stream@{Stream}}
...
)}}\label{class_stream_a2b738d6f4d3059de2ae3d444d68663bf}
...
\hypertarget{class_stream_a8047b62e7dcfe0e50210b3e40c7aa6eb}{\index{Stream@{Stream}!Calculate\-Length@{Calculate\-Length}}
...
\item[{bool \&}]{empty}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}, {\ttfamily [virtual]}}}\label{class_stream_a8047b62e7dcfe0e50210b3e40c7aa6eb}
...
Returns flag value. 
\end{DoxyReturn}
\hypertarget{class_stream_aee6c201819b874c5934a270592d9d311}{\index{Stream@{Stream}!Check\-Output\-Overflow\-Flag@{Check\-Output\-Overflow\-Flag}}
...
Returns flag value. 
\end{DoxyReturn}
\hypertarget{class_stream_ac7e3629626c1ea4d9cba88db1e048132}{\index{Stream@{Stream}!Flush\-Input\-Buffer@{Flush\-Input\-Buffer}}
\index{Flush\-Input\-Buffer@{Flush\-Input\-Buffer}!Stream@{Stream}}
\subsubsection[{Flush\-Input\-Buffer}]{\setlength{\rightskip}{0pt plus 5cm}void Stream\-::\-Flush\-Input\-Buffer (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}}\label{class_stream_ac7e3629626c1ea4d9cba88db1e048132}
Flushes the input buffer \hypertarget{class_stream_a0af6193f98fcf7bcd60eef84fce8699c}{\index{Stream@{Stream}!Flush\-Output\-Buffer@{Flush\-Output\-Buffer}}
\index{Flush\-Output\-Buffer@{Flush\-Output\-Buffer}!Stream@{Stream}}
\subsubsection[{Flush\-Output\-Buffer}]{\setlength{\rightskip}{0pt plus 5cm}void Stream\-::\-Flush\-Output\-Buffer (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}}\label{class_stream_a0af6193f98fcf7bcd60eef84fce8699c}
Flushes the output buffer \hypertarget{class_stream_a435b1b065846d3b24969cfc6dacabc6b}{\index{Stream@{Stream}!Flush\-Stream@{Flush\-Stream}}
\index{Flush\-Stream@{Flush\-Stream}!Stream@{Stream}}
\subsubsection[{Flush\-Stream}]{\setlength{\rightskip}{0pt plus 5cm}void Stream\-::\-Flush\-Stream (
\begin{DoxyParamCaption}
\item[{uint16\-\_\-t \&}]{start\-\_\-index, }
\item[{uint16\-\_\-t \&}]{stop\-\_\-index, }
\item[{uint16\-\_\-t \&}]{buffer\-\_\-size, }
\item[{bool \&}]{empty}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}, {\ttfamily [virtual]}}}\label{class_stream_a435b1b065846d3b24969cfc6dacabc6b}
...
\hline
\end{DoxyParams}
\hypertarget{class_stream_a71cec6c46f3d50cc3ab420e93ae434e1}{\index{Stream@{Stream}!Get\-Available\-Read\-Bytes@{Get\-Available\-Read\-Bytes}}
...
\end{DoxyReturn}
\hypertarget{class_stream_a6a16ddb03d3360cef4daf4d38245091d}{\index{Stream@{Stream}!Get\-Available\-Write\-Bytes@{Get\-Available\-Write\-Bytes}}
...
\end{DoxyReturn}
\hypertarget{class_stream_a4860b9602c68ab437520d321e4e97212}{\index{Stream@{Stream}!Get\-Input\-Buffer\-Length@{Get\-Input\-Buffer\-Length}}
\index{Get\-Input\-Buffer\-Length@{Get\-Input\-Buffer\-Length}!Stream@{Stream}}
\subsubsection[{Get\-Input\-Buffer\-Length}]{\setlength{\rightskip}{0pt plus 5cm}uint16\-\_\-t Stream\-::\-Get\-Input\-Buffer\-Length (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}}\label{class_stream_a4860b9602c68ab437520d321e4e97212}
Calculates the length of the readable part of the buffer. \begin{DoxyReturn}{Returns}
Length of valid data. 
\end{DoxyReturn}
\hypertarget{class_stream_ad8aea9131dbc1b422bdba2408d63492a}{\index{Stream@{Stream}!Get\-Output\-Buffer\-Length@{Get\-Output\-Buffer\-Length}}
\index{Get\-Output\-Buffer\-Length@{Get\-Output\-Buffer\-Length}!Stream@{Stream}}
\subsubsection[{Get\-Output\-Buffer\-Length}]{\setlength{\rightskip}{0pt plus 5cm}uint16\-\_\-t Stream\-::\-Get\-Output\-Buffer\-Length (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}}\label{class_stream_ad8aea9131dbc1b422bdba2408d63492a}
Calculates the length of the readable part of the buffer. \begin{DoxyReturn}{Returns}
Length of valid data 
\end{DoxyReturn}
\hypertarget{class_stream_a851572e5787cd98383d5118de378724b}{\index{Stream@{Stream}!Read@{Read}}
\index{Read@{Read}!Stream@{Stream}}
\subsubsection[{Read}]{\setlength{\rightskip}{0pt plus 5cm}uint16\-\_\-t Stream\-::\-Read (
\begin{DoxyParamCaption}
\item[{uint8\-\_\-t $\ast$}]{string, }
\item[{uint16\-\_\-t}]{size}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}}\label{class_stream_a851572e5787cd98383d5118de378724b}
...
\hline
\end{DoxyParams}
\hypertarget{class_stream_a6db4180f5834073f992608b856bddca2}{\index{Stream@{Stream}!Read\-Byte@{Read\-Byte}}
\index{Read\-Byte@{Read\-Byte}!Stream@{Stream}}
\subsubsection[{Read\-Byte}]{\setlength{\rightskip}{0pt plus 5cm}bool Stream\-::\-Read\-Byte (
\begin{DoxyParamCaption}
\item[{uint8\-\_\-t \&}]{byte}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}}\label{class_stream_a6db4180f5834073f992608b856bddca2}
Reads one byte from the input stream. \begin{DoxyReturn}{Returns}
Returns the read byte. 
\end{DoxyReturn}
\hypertarget{class_stream_a32e449304f65b5571fe848a503fc9d68}{\index{Stream@{Stream}!Read\-Byte\-From\-Buffer@{Read\-Byte\-From\-Buffer}}
\index{Read\-Byte\-From\-Buffer@{Read\-Byte\-From\-Buffer}!Stream@{Stream}}
\subsubsection[{Read\-Byte\-From\-Buffer}]{\setlength{\rightskip}{0pt plus 5cm}bool Stream\-::\-Read\-Byte\-From\-Buffer (
\begin{DoxyParamCaption}
\item[{uint8\-\_\-t \&}]{byte, }
...
\item[{bool \&}]{empty}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}, {\ttfamily [virtual]}}}\label{class_stream_a32e449304f65b5571fe848a503fc9d68}
...
\end{DoxyReturn}
\hypertarget{class_stream_a3f8e3c5513c6b8605c0fed74a3ed22bc}{\index{Stream@{Stream}!Read\-Byte\-From\-Output\-Stream@{Read\-Byte\-From\-Output\-Stream}}
\index{Read\-Byte\-From\-Output\-Stream@{Read\-Byte\-From\-Output\-Stream}!Stream@{Stream}}
\subsubsection[{Read\-Byte\-From\-Output\-Stream}]{\setlength{\rightskip}{0pt plus 5cm}bool Stream\-::\-Read\-Byte\-From\-Output\-Stream (
\begin{DoxyParamCaption}
\item[{uint8\-\_\-t \&}]{byte}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}, {\ttfamily [virtual]}}}\label{class_stream_a3f8e3c5513c6b8605c0fed74a3ed22bc}
Reads a byte from the output stream. \begin{DoxyReturn}{Returns}
Returns true if there are more bytes 
\end{DoxyReturn}
\hypertarget{class_stream_a752930f620aed4a3a80b243ce66e57ca}{\index{Stream@{Stream}!Read\-From\-Buffer@{Read\-From\-Buffer}}
\index{Read\-From\-Buffer@{Read\-From\-Buffer}!Stream@{Stream}}
\subsubsection[{Read\-From\-Buffer}]{\setlength{\rightskip}{0pt plus 5cm}uint16\-\_\-t Stream\-::\-Read\-From\-Buffer (
\begin{DoxyParamCaption}
\item[{uint8\-\_\-t $\ast$}]{buffer, }
\item[{uint16\-\_\-t \&}]{start\-\_\-index, }
\item[{uint16\-\_\-t \&}]{stop\-\_\-index, }
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}, {\ttfamily [virtual]}}}\label{class_stream_a752930f620aed4a3a80b243ce66e57ca}
...
\hline
\end{DoxyParams}
\hypertarget{class_stream_ab458be72cc54330f518f5ab35ab84106}{\index{Stream@{Stream}!Read\-From\-Output\-Stream@{Read\-From\-Output\-Stream}}
\index{Read\-From\-Output\-Stream@{Read\-From\-Output\-Stream}!Stream@{Stream}}
\subsubsection[{Read\-From\-Output\-Stream}]{\setlength{\rightskip}{0pt plus 5cm}uint16\-\_\-t Stream\-::\-Read\-From\-Output\-Stream (
\begin{DoxyParamCaption}
\item[{uint8\-\_\-t $\ast$}]{string, }
\item[{uint16\-\_\-t}]{size}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}, {\ttfamily [virtual]}}}\label{class_stream_ab458be72cc54330f518f5ab35ab84106}
Reads data from the input stream into the specified string. 
\begin{DoxyParams}{Parameters}
...
Reimplemented in \hyperlink{class_s_o_c_k_e_t_ad8ee6b81c9f30267406412a95264abed}{S\-O\-C\-K\-E\-T}, and \hyperlink{class_u_a_r_t_a8bb77ca27b4e17d608d2743313625ac4}{U\-A\-R\-T}.
...
Reimplemented in \hyperlink{class_s_o_c_k_e_t_abcddb460b7adf3595a813f08f3659356}{S\-O\-C\-K\-E\-T}.

\hypertarget{class_stream_a7b6a9a1f96e0f524e950863215128911}{\index{Stream@{Stream}!Write\-Byte\-To\-Buffer@{Write\-Byte\-To\-Buffer}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}, {\ttfamily [virtual]}}}\label{class_stream_a7b6a9a1f96e0f524e950863215128911}
...
\hline
\end{DoxyParams}
\hypertarget{class_stream_a0784d377cc92ddde7cc730be17a1a3aa}{\index{Stream@{Stream}!Write\-Byte\-To\-Input\-Stream@{Write\-Byte\-To\-Input\-Stream}}
...
\item[{uint8\-\_\-t \&}]{byte}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}, {\ttfamily [virtual]}}}\label{class_stream_a0784d377cc92ddde7cc730be17a1a3aa}
Writes a byte to the input stream. 
\begin{DoxyParams}{Parameters}
{\em byte} & The byte to be written. \\
\hline
\end{DoxyParams}
\hypertarget{class_stream_a5ba59861c0ab5977d7c92d6dcd72807c}{\index{Stream@{Stream}!Write\-To\-Buffer@{Write\-To\-Buffer}}
...
\item[{void($\ast$)({\bf Stream} $\ast$stream)}]{cb}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}, {\ttfamily [virtual]}}}\label{class_stream_a5ba59861c0ab5977d7c92d6dcd72807c}
...
\hypertarget{class_stream_a81139fc126566f9d42470fdb405ed26a}{\index{Stream@{Stream}!input\-\_\-buffer@{input\-\_\-buffer}}
...
Buffer that stores the input stream data. \hypertarget{class_stream_aff1c899af0d2dea35700d5665f378cd8}{\index{Stream@{Stream}!input\-\_\-buffer\-\_\-empty@{input\-\_\-buffer\-\_\-empty}}
...
Flag indicating whether the buffer is empty or full. \hypertarget{class_stream_ae7300cb8941cec142c14e8fc9baab9d3}{\index{Stream@{Stream}!input\-\_\-buffer\-\_\-overflowed@{input\-\_\-buffer\-\_\-overflowed}}
...
Flag indicating whether the input buffer has overflowed or not. This is reset when read by \hyperlink{class_stream_a088c4e68d568acfad715c56f408fe9f8}{Check\-Input\-Overflow\-Flag()}. \hypertarget{class_stream_a7373b1d6580a2d5dc74e788b3bb6a596}{\index{Stream@{Stream}!input\-\_\-buffer\-\_\-size@{input\-\_\-buffer\-\_\-size}}
...
The size of the input buffer. \hypertarget{class_stream_a6fc009e9e71fa92cbbf9b407ede82a73}{\index{Stream@{Stream}!input\-\_\-buffer\-\_\-start\-\_\-index@{input\-\_\-buffer\-\_\-start\-\_\-index}}
...
Indicates the first valid data byte in the buffer. \hypertarget{class_stream_aaceece6a2defd1f7d9667fcc0be03a7a}{\index{Stream@{Stream}!input\-\_\-buffer\-\_\-stop\-\_\-index@{input\-\_\-buffer\-\_\-stop\-\_\-index}}
...
Indicates the last valid data byte in the buffer. \hypertarget{class_stream_a3cd072a10ad5c1b6308dd2da2cdbec71}{\index{Stream@{Stream}!output\-\_\-buffer@{output\-\_\-buffer}}
...
Buffer that stores the output stream data. \hypertarget{class_stream_a54b21caaee0001e44968fb70d0a591f5}{\index{Stream@{Stream}!output\-\_\-buffer\-\_\-empty@{output\-\_\-buffer\-\_\-empty}}
...
Flag indicating whether the buffer is empty or full. \hypertarget{class_stream_a149776fead5c56894699da5bfe489b65}{\index{Stream@{Stream}!output\-\_\-buffer\-\_\-overflowed@{output\-\_\-buffer\-\_\-overflowed}}
...
Flag indicating whether the output buffer has overflowed or not. This is reset when read by \hyperlink{class_stream_aee6c201819b874c5934a270592d9d311}{Check\-Output\-Overflow\-Flag()}. \hypertarget{class_stream_a0e9fd6570bafb97ab76ebd37158e78ff}{\index{Stream@{Stream}!output\-\_\-buffer\-\_\-size@{output\-\_\-buffer\-\_\-size}}
...
The size of the output buffer. \hypertarget{class_stream_a1b2d63accede402e5c4c7fd3747d4c33}{\index{Stream@{Stream}!output\-\_\-buffer\-\_\-start\-\_\-index@{output\-\_\-buffer\-\_\-start\-\_\-index}}
...
Indicates the first valid data byte in the buffer. \hypertarget{class_stream_a39d177eedd4d5ff28a95cca9131daf4c}{\index{Stream@{Stream}!output\-\_\-buffer\-\_\-stop\-\_\-index@{output\-\_\-buffer\-\_\-stop\-\_\-index}}
