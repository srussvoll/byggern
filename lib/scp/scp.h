...
public:
     ...
     * @param data An array you want the data to be inserted into.
     * @param length_of_data The maximum data length.
     * @return Whether a command was available for reading.
     */
